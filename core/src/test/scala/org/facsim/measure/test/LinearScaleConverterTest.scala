...
//=============================================================================
/**
Test suite for the [[org.facsim.measure.LinearScaleConverter!]] class.
*/
//=============================================================================
...
Note: The values 0.0 and 1.0 are illegal factor values, and so are not included
here.
*/
...
/*
Verify that it accepts just about any other value (not all of which make
sense).
*/
