...
@param targetFamily Physical quantity family to which the value could not be
converted.
...
final class GenericConversionException private [measure] (measure:
Generic.Measure, targetFamily: Family)
