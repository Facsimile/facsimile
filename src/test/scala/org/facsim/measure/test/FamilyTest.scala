...
//=============================================================================
/**
Test suite for the [[org.facsim.measure.Family!]] class and
[[org.facsim.measure.Family$]] companion object.
*/
//=============================================================================
...
Since construction is handled internally, it should be impossible
*/
...
/*
If a unitless family is involved as one operand, the resulting product will be
the other operand.  When two unitless family instances are multiplied together,
the result is a unitless family instance.
*/
...
/*
If both operands are non-unitless family instances, then the resulting product
will be different to both of them.
*/
...
/*
If a unitless family is the right-hand operand, then the resulting quotient
will be the right-hand operand.  If the left-hand operand is unitless, then the
result will be the inverse of the right-hand operand.  When two unitless family
instances are involved, the result is unitless.
*/
...
/*
If both operands are non-unitless family instances, then the resulting quotient
will be different to both of them.
*/
