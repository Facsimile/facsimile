...
import org.facsim.facsimile.engine.OutOfEventsException;
import org.facsim.simtest.javaio.SerializableContract;

//=============================================================================
/**
<p>Test fixture examining consistency of org.facsim.facsimile.engine package
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    {
        log = new Log ("data/tmp/org.facsim.simtest.engine.ExceptionMessage."
        + Locale.getDefault () + ".log");
    }

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
<p>Test {@link org.facsim.facsimile.engine.OutOfEventsException}
exception messages.</p>
*/
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    @Test
    public void testOutOfEventsException ()
    {
...
*/
        ...
        log.writeMessage (OutOfEventsException.class,
        OutOfEventsException.testException ());
