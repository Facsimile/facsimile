 ...
 *
 *  @constructor Create a new point in 3D model space.
 *
 *  @param x Local X-axis co-ordinate.
 *
 *  @param y Local Y-axis co-ordinate.
 *
 *  @param z Local Z-axis co-ordinate.
 *
 *  @since 0.0
 */
...
object Point {
  ...
  /** Origin.
   *
   *  A point whose value is at the origin of the local axes.
   *
   *  @since 0.0
   */
