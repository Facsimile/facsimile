 ...
 *
 *  @param configFile _HOCON_ configuration file to be used to configure the simulation, wrapped in [[Some]], or
 *  [[None]] if the simulation is to solely use command line _Java_-style configuration properties and/or default
 *  configuration values.
 *
 *  @param logFile File into which log information should be written, wrapped in [[Some]], or [[None]] if the simulation
 *  should not write any log information.
 *
 ...
 *
 *  @param reportFile Simulation report file to be generated by this run, wrapped in [[Some]], or [[None]] if the
 *  simulation is not to issue a report for this run.
 *
