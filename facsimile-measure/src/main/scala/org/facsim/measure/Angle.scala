...
extends Specific {
  ...
  /** Physical quantity family for plane angle measurements.
    *
    * Plane angles are ''unitless'' measurements, with radian measure defined as the ratio one [[Length]] (the arc of
  ...
  /** Compute arc tangent from tangent value.
    ...
    * org.facsim.measure.Length$.Measure)]] function should be preferred where applicable, since it returns a fuller
