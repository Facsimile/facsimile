...
extends Specific {
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Millimetre millimeters]]''.
    ...
    * @since 0.0
    */
  val Millimeters = new Units(new LinearScaleConverter(MetersPerMM), LibResource("phys.Length.Millimeter.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Centimetre centimeters]]''.
    ...
    * @since 0.0
    */
  val Centimeters = new Units(new LinearScaleConverter(MetersPerCM), LibResource("phys.Length.Centimeter.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Metre meters]]''.
    ...
    * @since 0.0
    */
  val Meters = new Units(SIConverter, LibResource("phys.Length.Meter.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Kilometre kilometers]]''.
    ...
    * @since 0.0
    */
  val Kilometers = new Units(new LinearScaleConverter(MetersPerKM), LibResource("phys.Length.Kilometer.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Inch inches]]''.
    ...
    * @since 0.0
    */
  val Inches = new Units(new LinearScaleConverter(MetersPerInch), LibResource("phys.Length.Inch.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Foot_(unit) feet]]''.
    ...
    * @since 0.0
    */
  val Feet = new Units(new LinearScaleConverter(MetersPerFoot), LibResource("phys.Length.Foot.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Yard yards]]''.
    ...
    * @since 0.0
    */
  val Yards = new Units(new LinearScaleConverter(MetersPerYard), LibResource("phys.Length.Yard.sym"))
  ...
  /** Units for lengths measured in ''[[http://en.wikipedia.org/wiki/Mile miles]]''.
    ...
    * @since 0.0
    */
  val Miles = new Units(new LinearScaleConverter(MetersPerMile), LibResource("phys.Length.Mile.sym"))
  ...
  /** Length measurement factory function.
    *
    * @param measure Measurement, in meters, to be converted into a new measure.
    *
    * @return `measure` in the form of a Length measurement.
    */
