...
extends NonNegative {
  ...
  /** Units for temperatures measured in ''[[http://en.wikipedia.org/wiki/Celsius degrees Celsius]]''.
    ...
    * @since 0.0
    */
  val Celsius = new Units(new OffsetConverter(AbsoluteZeroCelsius), LibResource("phys.Temperature.Celsius.sym"))
  ...
  /** Units for temperatures measured in ''[[http://en.wikipedia.org/wiki/Fahrenheit degrees Fahrenheit]]''.
    ...
    * @since 0.0
    */
  val Fahrenheit = new Units(new LinearConverter(KelvinPerFahrenheitDegree, AbsoluteZeroFahrenheit),
  ...
  /** Units for temperatures measured in ''[[http://en.wikipedia.org/wiki/Kelvin degrees Kelvin]]''.
    ...
    * @since 0.0
    */
  val Kelvin = new Units(SIConverter, LibResource("phys.Temperature.Kelvin.sym"))
