...
extends Specific {
  ...
  /** Units for angles measured in ''[[http://en.wikipedia.org/wiki/Degree_(angle) degrees]]''.
    ...
    * @since 0.0
    */
  val Degrees = new Units(new LinearScaleConverter(τValue / 360.0), LibResource("phys.Angle.Degree.sym"))
  ...
  /** Units for angles measured in ''[[http://en.wikipedia.org/wiki/Gradian gradians]]''.
    ...
    * @since 0.0
    */
  val Gradians = new Units(new LinearScaleConverter(τValue / 400.0), LibResource("phys.Angle.Gradian.sym"))
  ...
  /** Units for angles measured in ''[[http://en.wikipedia.org/wiki/Radian radians]]''.
    ...
    * @since 0.0
    */
  val Radians = new Units(SIConverter, LibResource("phys.Angle.Radian.sym"))
  ...
  /** Units for angles measured in ''[[http://en.wikipedia.org/wiki/Turn_(geometry) turns]]'' (also known as ''cycles''
    ...
    * @since 0.0
    */
  val Turns = new Units(new LinearScaleConverter(τValue), LibResource("phys.Angle.Turn.sym"))
  ...
  /** Physical quantity family for plane angle measurements.
    ...
    */
  protected[phys] override val family = Family.Unitless
