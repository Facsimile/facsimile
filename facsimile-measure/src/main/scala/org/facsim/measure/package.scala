 ...
 *
 *  Elements defined within this package support ''[[https://en.wikipedia.org/wiki/Dimensional_analysis dimensional
 ...
 *  expressed in one or more ''[[https://en.wikipedia.org/wiki/Units_of_measure units of measure]]'' of that quantity.
 ...
 *      and ''length''.
 *   1. Ensure unit of measure ''type safety'', and to prevent accidental confusion of different units of the same
 ...
 *   1. To allow the user, or end-user, the option to select their preferred units of measure for each quantity, without
 ...
 *
 *  One common approach is to use [[scala.Double]] for all measurements, regardless of quantities or units of measure.
 ...
 *  }}}
 *
 *  This is because `distance` is implied to be a [[org.facsim.measure.phys.Length]] with a value of 5 ''meters'', with
 *  `timeTaken` implied to be a [[org.facsim.measure.phys.Time]] with a value of 10 ''seconds''. Because a ''length''
 ...
 *  implied to have the type [[scala.util.Try]][ [[org.facsim.measure.phys.Velocity]] ] and ends up with a value of
 ...
 *
 *  @see [[[[https://en.wikipedia.org/wiki/Units_of_measure Units of measure]] on ''Wikipedia''.
 *
 *  @since 0.0
 */
