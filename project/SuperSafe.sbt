...
//======================================================================================================================
// SBT SuperSafe plugin, which ensures correctness for Scalactic expessions.
//
// If this plugin causes resolution errors, add the following line to the ~/.sbt/1.0/resolvers.sbt file:
//
