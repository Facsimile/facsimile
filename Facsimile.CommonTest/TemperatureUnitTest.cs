...
//=============================================================================
/**
<summary>NUnit test fixture for the <see cref="TemperatureUnit" />
class.</summary>
*/
//=============================================================================
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        {
            Assert.AreSame (TemperatureUnit.Kelvin, MeasurementUnit.GetStandard
            (typeof (TemperatureUnit)));
        }

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/**
<summary>Tests that the <see cref="TemperatureUnit.IsStandard" /> property
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        {
            Assert.IsTrue (TemperatureUnit.Kelvin.IsStandard);
            Assert.IsFalse (TemperatureUnit.DegreesCelsius.IsStandard);
            Assert.IsFalse (TemperatureUnit.DegreesFahrenheit.IsStandard);
        }
    }
}
