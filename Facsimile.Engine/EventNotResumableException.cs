...
C# source file for the EventNotResumableException class, and associated
...
//=============================================================================
/**
<summary>Attempt to resume an event in inappropriate state.</summary>

<remarks>Exception thrown whenever the an attempt is made to call <see
cref="IEvent.Resume ()" /> on a <see cref="IEvent" /> sub-class instance that
is not in an appropriate state.</remarks>
*/
//=============================================================================

    public sealed class EventNotResumableException:
...
<remarks>Record the names of the event class and it's current state
class.</remarks>

<param name="unresumableEvent">The <see cref="IEvent" /> sub-class instance
that is not suspendable.</param>
*/
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

        internal EventNotResumableException (IEvent unresumableEvent)
        {
...
*/
            ...
            System.Diagnostics.Debug.Assert (unresumableEvent != null);
...
*/
            ...
            {
                unresumableEvent.GetType ().FullName,
                unresumableEvent.CurrentState.GetType ().FullName,
            };
        }
