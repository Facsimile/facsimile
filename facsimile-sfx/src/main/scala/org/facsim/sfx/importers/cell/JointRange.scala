 ...
 *
 *  @param maximum Maximum permitted joint value. Must be greater than or equal to `current`.
 */
private[cell] final case class JointRange(minimum: Double, current: Double, maximum: Double) {
