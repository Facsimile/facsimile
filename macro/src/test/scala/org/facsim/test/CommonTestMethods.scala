...
//----------------------------------------------------------------------------------------------------------------------
/**
Assert that a NullPointerException's message resulting from a [[org.facsim.requireNonNull(AnyRef)*]] failure matches the
expected value.
...
//----------------------------------------------------------------------------------------------------------------------
/**
Assert that an IllegalArgumentException's message resulting from a [[org.facsim.requireValid(Any,Boolean)*]] failure
...
//----------------------------------------------------------------------------------------------------------------------
/**
Assert that an IllegalArgumentException's message resulting from a [[org.facsim.requireFinite(Double)*]] failure matches
the expected value.
